...
<h1 class="text-center mb-sm-5 mb-3 mt-sm-4 mt-3 font-weight-bold"> REGULAMIN </h1>
...
<div class="container">
    ...
    <p>
        ...
        połączeń
        internetowych. Minimalne wymagania techniczne umożliwiające korzystanie ze Strony Internetowej Sklepu to
        przeglądarka internetowa w wersji co najmniej Internet Explorer 11 lub Chrome 66 lub FireFox 60 lub Opera 53 lub
        Safari 5 lub nowszych, z włączoną obsługą języka Javascript, akceptująca pliki typu „cookies” oraz łącze
        internetowe
        o przepustowości co najmniej 256 kbit/s. Strona Internetowa Sklepu jest zoptymalizowana dla minimalnej
        rozdzielczości ekranu 1024x768 pikseli.
        <br>
        3. Sprzedawca stosuje mechanizm plików "cookies", które podczas korzystania przez Klientów ze Strony
        Internetowej
        Sklepu, zapisywane są przez serwer Sprzedawcy na dysku twardym urządzenia końcowego Klienta. Stosowanie plików
        "cookies" ma na celu poprawne działanie Strony Internetowej Sklepu na urządzeniach końcowych Klientów. Mechanizm
        ten
        nie niszczy urządzenia końcowego Klienta oraz nie powoduje zmian konfiguracyjnych w urządzeniach końcowych
        Klientów
        ani w oprogramowaniu zainstalowanym na tych urządzeniach. Każdy Klient może wyłączyć mechanizm „cookies” w
        przeglądarce internetowej swojego urządzenia końcowego. Sprzedawca wskazuje, że wyłączenie „cookies” może jednak
        spowodować utrudnienia lub uniemożliwić korzystanie ze Strony Internetowej Sklepu.
        <br>
        4. W celu złożenia zamówienia w Sklepie Internetowym za pośrednictwem Strony Internetowej Sklepu oraz w celu
        ...
        Sklepu Internetowego, Strony Internetowej Sklepu lub usług nieodpłatnych świadczonych przez Sprzedawcę, w sposób
        ...
        szczególności powinni stosować programy antywirusowe i chroniące tożsamość korzystających z sieci Internet.
    ...
    <p>
        ...
        <br>
        2. Klient może składać zamówienia w Sklepie Internetowym za pośrednictwem Strony Internetowej Sklepu przez 7 dni
        w
        ...
        Towar,
        którym jest zainteresowany. Dodanie Towaru do zamówienia następuje przez wybór polecenia "DODAJ" pod danym
        Towarem
    ...
    <p>
        ...
        <br>
        a) złożyć oświadczenie o obniżeniu ceny albo odstąpieniu od Umowy sprzedaży, chyba że Sprzedawca niezwłocznie i
        bez
        ...
        Sprzedawca
        nie uczynił zadość obowiązkowi wymiany Towaru na wolny od wad lub usunięcia wad. Klient może zamiast
        zaproponowanego
        przez Sprzedawcę usunięcia wady żądać wymiany Towaru na wolny od wad albo zamiast wymiany Towaru żądać usunięcia
        wady, chyba że doprowadzenie rzeczy do zgodności z umową w sposób wybrany przez Klienta jest niemożliwe albo
        wymagałoby nadmiernych kosztów w porównaniu ze sposobem proponowanym przez Sprzedawcę. Przy ocenie nadmierności
        kosztów uwzględnia się wartość Towaru wolnego od wad, rodzaj i znaczenie stwierdzonej wady, a także bierze się
        pod
        ...
        wadliwy na wolny od wad lub usunąć wadę w rozsądnym czasie bez nadmiernych niedogodności dla Klienta.
        Sprzedawca może odmówić zadośćuczynienia żądaniu Klienta, jeżeli doprowadzenie do zgodności z Umową sprzedaży
        Towaru
        wadliwego w sposób wybrany przez Klienta jest niemożliwe lub w porównaniu z drugim możliwym sposobem
        doprowadzenia
        do zgodności z Umową sprzedaży wymagałoby nadmiernych kosztów. Koszty naprawy lub wymiany ponosi Sprzedawca.
        <br>
        ...
        <br>
        4. Sprzedawca odpowiada z tytułu rękojmi, jeżeli wada fizyczna zostanie stwierdzona przed upływem dwóch lat od
        wydania Towaru Klientowi. Roszczenie o usunięcie wady lub wymianę Towaru na wolny od wad przedawnia się z
        upływem
        roku, lecz termin ten nie może zakończyć się przed upływem terminu określonego w zdaniu pierwszym. W tym
        terminie
        Klient może odstąpić od Umowy sprzedaży lub złożyć oświadczenie o obniżeniu ceny z powodu wady Towaru. Jeżeli
        Klient
        żądał wymiany Towaru na wolny od wad lub usunięcia wady, termin do odstąpienia od Umowy sprzedaży lub złożenia
        oświadczenia o obniżeniu ceny rozpoczyna się z chwilą bezskutecznego upływu terminu do wymiany Towaru lub
        usunięcia
        wady.
        <br>
        5. Sprzedawca nie korzysta z pozasądowego rozwiązywania sporów, o których mowa w ustawie z dnia 23 września 2016
        r.,
    ...
    <p>
        <b> § 7 Reklamacje </b>
        <br>
        1. Wszelkie reklamacje związane z Towarem lub realizacją Umowy sprzedaży, Klient może kierować w formie pisemnej
        na
        adres Sprzedawcy.
        <br>
        ...
        arnetgryfow@poczta.onet.pl. W zgłoszeniu reklamacyjnym Klient winien zawrzeć opis zaistniałego problemu.
        Sprzedawca
    ...
    <p>
        <b> § 9 Odstąpienie od Umowy sprzedaży </b>
        <br>
        ...
        Konsumenta.
        Konsument może odstąpić od Umowy sprzedaży składając Sprzedawcy oświadczenie o odstąpieniu. Oświadczenie to może
        zostać złożone przykładowo pisemnie na adres Sprzedawcy, za pośrednictwem poczty elektronicznej na adres
        Sprzedawcy.
        Oświadczenie można złożyć na formularzu, którego wzór został zamieszczony przez Sprzedawcę na Stronie
        Internetowej
        Sklepu pod adresem: Formularz odstąpienia. Do zachowania terminu wystarczy wysłanie oświadczenia przed jego
        upływem.
        Konsument może odstąpić od Umowy sprzedaży, składając Sprzedawcy oświadczenie o odstąpieniu za pośrednictwem
        formularza udostępnionego na stronie internetowej pod adresem: Elektroniczny Formularz odstąpienia. Do
        zachowania
        terminu wystarczy wysłanie oświadczenia przed jego upływem. Sprzedawca niezwłocznie potwierdza Konsumentowi
        ...
        Konsumenta o odstąpieniu od Umowy sprzedaży, zwrócić mu wszystkie dokonane przez niego płatności, w tym koszt
        Dostawy Towaru do Konsumenta. Sprzedawca może wstrzymać się ze zwrotem płatności otrzymanych od Konsumenta do
        chwili
        otrzymania z powrotem Towaru lub dostarczenia przez Konsumenta dowodu odesłania Towaru, w zależności od tego,
        które
        zdarzenie nastąpi wcześniej.
        <br>
        6. Jeżeli Konsument korzystający z prawa do odstąpienia wybrał sposób dostarczenia Towaru inny niż najtańszy
        zwykły
        sposób Dostawy oferowany przez Sprzedawcę, Sprzedawca nie jest zobowiązany do zwrotu Konsumentowi poniesionych
        przez
        ...
        dnia, w
        którym odstąpił od Umowy sprzedaży. Do zachowania terminu wystarczy odesłanie Towaru na adres Sprzedawcy przed
        ...
        <br>
        10. Konsument ponosi odpowiedzialność za zmniejszenie wartości Towaru będące wynikiem korzystania z niego w
        sposób
        ...
        <br>
        12. Prawo odstąpienia od Umowy sprzedaży nie przysługuje Klientowi będącemu Konsumentem w odniesieniu do umów, w
        których Towarem jest rzecz nieprefabrykowana, wyprodukowana według specyfikacji Konsumenta lub służąca
        zaspokojeniu
        jego zindywidualizowanych potrzeb.
    </p>
    <p>
        <b> § 10 Usługi nieodpłatne </b>
        <br>
        ...
        <br>
        4. Usługa Formularz kontaktowy polega na wysłaniu za pomocą formularza umieszczonego na Stronie Internetowej
        Sklepu
        ...
        i
        polega na udostępnieniu Klientowi dedykowanego panelu w ramach Strony Internetowej Sklepu, umożliwiającego
        Klientowi
        modyfikacje danych, które podał podczas Rejestracji, jak też śledzenia historii
        zamówień już zrealizowanych.
        <br>
        11. Klient, który dokonał Rejestracji może zgłosić Sprzedawcy żądanie usunięcia Konta Klienta, przy czym w
        przypadku
        zgłoszenia żądania usunięcia Konta Klienta przez Sprzedawcę, może ono zostać usunięte do 14 dni od zgłoszenia
        żądania.
        <br>
        12. Sprzedawca jest uprawniony do zablokowania dostępu do Konta Klienta i usług nieodpłatnych, w przypadku
        działania
        przez Klienta na szkodę Sprzedawcy lub innych Klientów, naruszenia przez Klienta przepisów prawa lub postanowień
        Regulaminu, a także, gdy zablokowanie dostępu do Konta Klienta i usług nieodpłatnych jest uzasadnione względami
        bezpieczeństwa - w szczególności: przełamywaniem przez Klienta zabezpieczeń Strony Internetowej Sklepu lub
        innymi
        działaniami hakerskimi. Zablokowanie dostępu do Konta Klienta i usług nieodpłatnych z wymienionych przyczyn trwa
        przez okres niezbędny do rozwiązania kwestii stanowiącej podstawę zablokowania dostępu do Konta Klienta i usług
        nieodpłatnych. Sprzedawca zawiadamia Klienta o zablokowaniu dostępu do Konta Klienta i usług nieodpłatnych drogą
        elektroniczną na adres podany przez Klienta w formularzu rejestracyjnym.
    </p>
    <p>
        <b> § 11 Rozwiązanie umowy (nie dotyczy Umów sprzedaży)</b>
        <br>
        1. Zarówno Klient, jak i Sprzedawca mogą rozwiązać umowę o świadczenie usług drogą elektroniczną w każdym czasie
        i
        bez podania przyczyn, z zastrzeżeniem zachowania praw nabytych przez drugą stronę przed rozwiązaniem ww. umowy
        oraz
        postanowień poniżej.
        <br>
        2. Klient, który dokonał Rejestracji rozwiązuje umowę o świadczenie usług drogą elektroniczną, poprzez wysłanie
        do
        Sprzedawcy stosownego oświadczenia woli, przy użyciu dowolnego środka komunikacji na odległość, umożliwiającego
        zapoznanie się Sprzedawcy z oświadczeniem woli Klienta.
        <br>
        3. Sprzedawca wypowiada umowę o świadczenie usług drogą elektroniczną poprzez wysłanie do Klienta stosownego
        oświadczenia woli na adres poczty elektronicznej podany przez Klienta podczas Rejestracji.
    </p>
    <p>
        <b>§ 12 Postanowienia końcowe </b>
        <br>
        1. Sprzedawca ponosi odpowiedzialność z tytułu niewykonania lub nienależytego wykonania umowy, lecz w przypadku
        umów
        ...
        <br>
        2. Treść niniejszego Regulaminu może zostać utrwalona poprzez wydrukowanie, zapisanie na nośniku lub pobranie w
        każdej chwili ze Strony Internetowej Sklepu.
        <br>
        ...
        prawo polskie.
        <br>
        4. Sprzedawca informuje Klienta będącego Konsumentem o możliwości skorzystania z pozasądowych sposobów
        rozpatrywania
        reklamacji i dochodzenia roszczeń. Zasady dostępu do tych procedur dostępne są w siedzibach lub na stronach
        internetowych podmiotów uprawnionych do pozasądowego rozpatrywania sporów. Mogą nimi być w szczególności
        rzecznicy
        praw konsumenta lub Wojewódzkie Inspektoraty Inspekcji Handlowej, których lista jest dostępna na stronie
        internetowej Urzędu Ochrony Konkurencji i Konsumentów.
        Sprzedawca informuje, że pod adresem http://ec.europa.eu/consumers/odr/ dostępna jest platforma internetowego
        systemu rozstrzygania sporów pomiędzy konsumentami i przedsiębiorcami na szczeblu unijnym (platforma ODR).
        <br>
        5. Sprzedawca zastrzega sobie prawo zmiany niniejszego Regulaminu. Wszystkie zamówienia przyjęte przez
        Sprzedawcę do
        realizacji przed dniem wejścia w życie nowego Regulaminu są realizowane na podstawie Regulaminu, który
        obowiązywał w
        dniu składania zamówienia przez Klienta. Zmiana Regulaminu wchodzi w życie w terminie 7 dni od dnia
        opublikowania na
        Stronie Internetowej Sklepu. Sprzedawca poinformuje Klienta na 7 dni przed wejściem w życie nowego Regulaminu o
