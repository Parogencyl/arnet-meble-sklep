...
class OrderFakturaPostRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'street2.required' => 'Należy wypełnić podane pole.',
            ...
            'zip2.required' => 'Należy wypełnić podane pole.',
            ...
            'company.required' => 'Należy wypełnić podane pole.',
            'company.max' => 'Zbyt duża liczba znaków',
            'nip.required' => 'Należy wypełnić podane pole.',
            'nip.max' => 'Maksymalna liczba znaków wynosi 15.',
